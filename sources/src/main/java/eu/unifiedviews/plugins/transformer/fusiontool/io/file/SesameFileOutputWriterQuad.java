...
/**
 * Implementation of {@link FileOutputWriter} writing to a given Sesame {@link RDFHandler} with support for named graphs. The
...
public class SesameFileOutputWriterQuad extends SesameFileOutputWriterBase {
     ...
     */
    public SesameFileOutputWriterQuad(RDFHandler rdfWriter, Closeable underlyingResource, URI dataContext, URI metadataContext) 
            throws IOException {
